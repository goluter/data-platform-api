...
public class PostSpecification {
    public static Specification<StoreItem> find(User reader, Optional<String> subject, Optional<String> category) {
        return (Specification<StoreItem>) ((root, query, builder) -> {
